...
public class Hello {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(theLatestCreationTime);
		System.out.println(today);
		System.out.println(today.after(theLatestCreationTime));
		...
		System.out.println(creationTime.after(theLatestCreationTime));
